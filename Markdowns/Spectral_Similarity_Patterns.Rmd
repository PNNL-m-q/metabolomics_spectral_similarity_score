...
I have another figure request: could you generate this kind of figure (https://cran.r-project.org/web/packages/ggalluvial/vignettes/ggalluvial.html) that will show how each of the sum clusters partition into the ten metric families?
